function mgp_op_wrsame_ccdi(firstDsp,lastDsp,len,startAddress,data,varargin)
% mgp_op_wrsame_ccdi(firstDsp,lastDsp,len,startAddress,data,[connectionNr],[dataType])
...
pnet(udpSocket,'WRITEMGPPACKET',firstDsp,lastDsp,startAddress,155,1,len,data,'intel')';
