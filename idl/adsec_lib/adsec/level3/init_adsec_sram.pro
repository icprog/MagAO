;$Id: init_adsec_sram.pro,v 1.2 2008/10/02 13:52:21 labot Exp $$
;
;+
;  NAME:
;   INIT_ADSEC_SRAM
...
;
;  USAGE:
;   err = INIT_ADSEC_SRAM(STRUCT=struct, NOFILL=nofill)
;
;  INPUT:
;   None.
;
...
;  
Function init_adsec_sram, STRUCT=struct, NOFILL=nofill
...
; Read the data gain data
    err = get_sram_data(sc.all, mat_cal)
