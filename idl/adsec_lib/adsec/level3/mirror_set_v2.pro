;$Id: mirror_set_v2.pro,v 1.1 2007/06/26 13:58:37 labot Exp $
;+
;	NAME:
;		MIRROR_SET_V2
;	
...
function mirror_set_v2, INIT_THREE_POS=initial_three_pos, THREE_POS=three_pos, THREE_ACT=three_act $
...
err = set_isostatic_v2(three_act, initial_three_pos, three_pos, s_gain, i_gain, XADSEC=xadsec, /TILT)
if err ne adsec_error.ok then return, err
