...
% step response                                   %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
aoWrite('hvc_TT2_step_ptr_preshaper_cmd',round(sys_data.pres_buff_size/.2/sys_data.cntFreq)*ones(sys_data.nAct,1),0:sys_data.nAct-1,1,sys_data.mirrorActMap);
aoWrite('hvc_TT2_step_ptr_preshaper_curr',round(sys_data.pres_buff_size/.2/sys_data.cntFreq)*ones(sys_data.nAct,1),0:sys_data.nAct-1,1,sys_data.mirrorActMap);
...
aoBufferArray(2).dspPointer=aoGetAddress('hvc_TT2_preshaped_cmd'); % pointer of read/write element
...
% aoBufferArray(3).dspPointer=aoGetAddress('hvc_TT2_preshaped_curr'); % pointer of read/write element
aoBufferArray(3).dspPointer=aoGetAddress('hvc_TT2_float_DAC_value'); % pointer of read/write element
...
aoBufferArray(4).dspPointer=aoGetAddress('hvc_TT2_uint_DAC_value'); % pointer of read/write element
...
%aoWrite('hvc_command_vector',[0 0 0 0 10e-6 -10e-6 0 0],sys_data.hvc_board);
