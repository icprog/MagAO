...
//		return NO_ERROR;
	...
	pos = dummyPos;//StepsToUnits( loadpos );
...
int CopleyCtrl::EnableReqChanged( void *pt, Variable *var)
{
   ...
   //DeadX: always fake enable
   //enable_req = ENABLE_ALWAYS;
...
int CopleyCtrl::SpecialReqChanged( void *pt, Variable *var)
{
      ...
      //DeadX: whatever this is, don't do it.
      //if (value == 1)
...
int CopleyCtrl::MoveTo( double tgtpos)
{
   ...
   //DeadX: just set new position and go
   dummyPos = tgtpos;
   return NO_ERROR;
