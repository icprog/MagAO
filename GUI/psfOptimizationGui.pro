...
INTERFACES = QtDesigner/psfOptimization_gui.ui

HEADERS += psfOptimizationGui.h AOAppGui.h
SOURCES += psfOptimizationGui.cpp AOAppGui.cpp $(ADOPT_SOURCE)/lib/base/build_time.c
