...
//Static fields
int VisAOSimpleMotorCtrl::control_mode = VisAOSimpleMotorCtrl::CMODE_LOCAL;
   
int VisAOSimpleMotorCtrl::default_control_mode = CMODE_LOCAL;
...
void VisAOSimpleMotorCtrl::SetupVars()
{
   ...
   VisAOSimpleMotorCtrl::request_control(default_control_mode, 1);
}
...
int VisAOSimpleMotorCtrl::request_control(int cmode, bool override)
{
   ...
   {
      if(cmode == CMODE_NONE && control_mode != default_control_mode) cmode = default_control_mode;
