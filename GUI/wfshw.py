...
from AdOpt.WfsGUI.sc_gui import *
...
class GUIMain( EngineeringGui):
    ...
    def __init__(self):
        ...
        self.setCaption('WFS hardware GUI')

        dialogs = ['power_gui','ccd39_gui', 'VisAOccd47_gui', 'sc_gui', 'filter_wheel1', 'VisAOfilter_wheel2', 'VisAOfilter_wheel3','status_gui',
