function aoClearFlash(flashBlock,varargin)
% aoClearFlash(flashBlock,[firstDsp,[lastDsp]],[connectionNr])
% clears a specified flashBlock
%
...
disp(['clearing ',MGP_FLASH_TABLE(flashBlock).name]);
% %flashing
mgp_op_clear_flash(firstDsp,lastDsp,1,startAddress,blockLen,connectionNr);
