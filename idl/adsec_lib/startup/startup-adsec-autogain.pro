...
if !version.os eq 'Win32' then !AO_CONST.conf_file = 'conf\adsec\current\processConf\adsec.conf' else !AO_CONST.conf_file = 'conf/adsec/current/processConf/adsec_autogain.conf'
