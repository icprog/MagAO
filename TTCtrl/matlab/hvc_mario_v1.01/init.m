...
HvcMainProgram = './firmware/HVCMainProgram_1_02.ldr';
...
sys_data.DACV2BitGain_c2  = -32768/120.51*0.9953; % questo e' un guadagno Volt2bit per il canale common
sys_data.DACV2BitGain_c5  = -32768/120.51*1.0068; % questo e' un guadagno Volt2bit per il canale common
...
if DO_INIT
   ...
   aoWrite('hvc_TT1_DAC_A2bit_gain',[sys_data.DACr2BitGain_x sys_data.DACr2BitGain_y sys_data.DACV2BitGain_c2 0],0:(sys_data.nAct-1));
   ...
   aoWrite('hvc_TT2_DAC_A2bit_gain',[sys_data.DACm2BitGain_x sys_data.DACm2BitGain_y sys_data.DACV2BitGain_c5 0],0:(sys_data.nAct-1));
