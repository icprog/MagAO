...
class Adam {
	...
	public:
		 ...
		 *
		 */
		Adam(string adamName="", bool testConn = false) throw (AdamException);
      ...
      bool readInputStatus( unsigned int *bitmask);
...
class AdamModbus {
	...
	public:
		 ...
		 *
		 */
		AdamModbus(string name="ADAM-MODBUS", bool initTCP=true) throw(AOException);
      ...
      void setLogLevel(int level);
		...
		bool SendForceSingleCoil(int i_iAddr,
                                 ...
                                 int *i_iTranId = NULL);
		bool RecvForceSingleCoil(int i_iTranId = 0);
		...
		bool SendPresetSingleReg(int i_iAddr,
								 ...
								 int i_iData,
                                 int *i_iTranId = NULL);
		bool RecvPresetSingleReg(int i_iTranId = 0);
		...
		bool SendForceMultiCoils(int i_iAddr,
                                 ...
                                 int *i_iTranId = NULL);
		bool RecvForceMultiCoils(int i_iTranId = 0);
		...
		bool SendPresetMultiRegs(int i_iAddr,
								 ...
								 unsigned char i_szData[],
                                 int *i_iTranId = NULL);
		bool RecvPresetMultiRegs(int i_iTranId = 0);
    ...
    // specific
        bool SetSingleCoil(int coil, int value);
        bool SetMultiCoils(unsigned char data);
