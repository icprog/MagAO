function data=mgp_op_rd_ccdi(firstDsp,lastDsp,len,startAddress,varargin)
% mgp_op_rd_ccdi(firstDsp,lastDsp,len,startAddress,[connectionNr],[dataType])
...
data=pnet(udpSocket,'READMGPPACKET',firstDsp,lastDsp,startAddress,156,1,len,dataType,'intel')';
data=double(data);
