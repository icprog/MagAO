...
# Configuration information for unit W2
...
ccd_darkvariable = {}
ccd_darkvariable['ccd39'] = 'slopecompctrl.'+side+'.DARK'
ccd_darkvariable['ccd47'] = 'techviewctrl.'+side+'.DARK'
ccd_darkvariable['irtc'] = side+'.IRTC.DARK'
ccd_darkvariable['pisces'] = side+'.PISCES.DARK'
