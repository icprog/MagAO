#@File: irtc.py
#
# Python module to read from IRTC at the telescope.
#
# Assumes that the archive:/newdata TCS directory is mounted locally on /mnt/newdata.
# IRTC acquisition is triggered by an irc command running on obs4, and then read from the newdata directory.
