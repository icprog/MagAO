function mgp_op_hl_wrseq_dsp(firstDsp,lastDsp,len,startAddress,data,varargin)
% mgp_op_hl_wrseq_dsp(firstDsp,lastDsp,len,startAddress,data,[connectionNr],[dataType],[FLAGS])
