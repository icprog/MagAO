...
function filt_flat4, sys_status_flat, sys_status_ini, DISPL=disp_plot, INIT=file1, FLAT=file2, ACT_FILTERED=act_removed_list, ACT_LIST=act_list_tmp, SKIPFILT=skipfilt
