function mgp_op_wrshmram(firstDsp,lastDsp,len,startAddress,data,varargin)
% mgp_op_wrshmram(first,last,len,startAddress,data,[connectionNr],[dataType])
...
pnet(udpSocket,'WRITEMGPPACKET',firstDsp,lastDsp,startAddress,135,1,len,data,'intel')';
