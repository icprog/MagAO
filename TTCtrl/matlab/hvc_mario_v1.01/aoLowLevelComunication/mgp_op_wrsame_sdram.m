function mgp_op_wrsame_sdram(firstDsp,lastDsp,len,startAddress,data,varargin)
...
pnet(udpSocket,'WRITEMGPPACKET',firstDsp,lastDsp,startAddress,142,1,len,data,'intel')';
