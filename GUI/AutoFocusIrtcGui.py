...
from AdOpt.QtDesigner.AutoFocusIrtc_gui import *
...
class AutoFocusIrtcGui(autoFocusIrtc_gui, thAOAppGUI):

    def __init__(self, qApp):
        thAOAppGUI.__init__(self, qApp, 'FocusIrtc')
        autoFocusIrtc_gui.__init__(self)
    ...
    def buttonStart_clicked(self):
        ...
        #print zRange, numSamples, numFrames, cx, cy

        tracknum, positions = autoFocusIrtc( self, zRange = zRange, numSamples = numSamples, numFrames = numFrames)
